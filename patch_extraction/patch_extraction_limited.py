...
def save_patches(slice_no, slice_length, pickled_files_path, dg_path, struct_locs_landuse_path, s_l_file, output_path):
    ...
    # if slice_no == 20:
    #     folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_127_9_pickle_file"]
    # elif slice_no == 21:
    #     folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_128_9_pickle_file", "/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_126_9_pickle_file"]
    # elif slice_no == 30:
    #     folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_308_126_9_pickle_file", "/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_311_129_9_pickle_file"]

    if slice_no == 31:
        folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_127_9_pickle_file"]
    elif slice_no == 32:
        folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_128_9_pickle_file"]
    elif slice_no == 33:
        folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_305_126_9_pickle_file"]
    elif slice_no == 34:
        folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_308_126_9_pickle_file"]
    elif slice_no == 35:
        folders_to_process = ["/home/zshah/DG_struct_locs/pickled_outputs/AOP_AF20_Q417_V0_508_311_129_9_pickle_file"]
...
print("#################################")
print("Slice Number: {}".format(slice_no),flush=True)
print("#################################")
...
output_path = "/mnt/nfs/eguide/projects/bldgpop/patches/buildings_landcover/"
